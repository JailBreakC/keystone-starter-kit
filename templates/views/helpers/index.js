...
module.exports = function () {
  ...
  // 将 cloudinary 地址转换为阿里云 cdn 地址
  _helpers.cdn = function (originUrl, options) {
    originUrl = originUrl.replace('res.cloudinary.com', 'fengqun-image.vgee.cn');
    return new hbs.SafeString(originUrl);
  };

  // i18n
  _helpers._ = function (key, options) {
    const root = options.data.root;
    return root.languagePack[key][root.lang];
  };
